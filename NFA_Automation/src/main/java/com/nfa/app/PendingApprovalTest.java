...
import com.nfa.pom.PendingApprovalPage;
...
public class PendingApprovalTest {
	...
	ExtentTest test;
	LoginPage loginPage;
	PendingApprovalPage pendingapproval;
	...
	public void setup() throws Exception {
		...
		try {
			...
			pendingapproval = new PendingApprovalPage(WebDriver_Instance.driver);
	...
	@DataProvider(name = "pending approval")
	...
	public void ApproverLogin(String username, String password) throws InterruptedException {
		...
		Thread.sleep(3000);	
		Action.click(ApproverHomePage.apprMenuPendingApproval);
		
		Thread.sleep(1000);
		Action.click(PendingApprovalPage.penAppSearch);
