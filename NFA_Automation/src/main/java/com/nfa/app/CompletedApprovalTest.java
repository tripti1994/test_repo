...
import com.nfa.pom.CompletedApproval;
...
public class CompletedApprovalTest {
	ExtentReports extent;
	ExtentHtmlReporter htmlReporter;
	ExtentTest test;
	LoginPage loginPage;
	CompletedApproval completedapproval;
	ApproverHomePage approverhomepage;
	...
	public void setup() throws Exception {
		...
		try {
			...
			completedapproval = new CompletedApproval(WebDriver_Instance.driver);
			approverhomepage = new ApproverHomePage(WebDriver_Instance.driver);
	...
	@DataProvider(name = "Completed Approval")
	...
	public void ApproverLogin(String username, String password) throws InterruptedException {
		...
		Thread.sleep(10000);	
		Action.click(ApproverHomePage.apprMenu);
		
		Thread.sleep(2000);	
		Action.click(ApproverHomePage.apprMenuCompletedAprroval);
		
		Thread.sleep(2000);
		Action.click(CompletedApproval.comapprSearch);
