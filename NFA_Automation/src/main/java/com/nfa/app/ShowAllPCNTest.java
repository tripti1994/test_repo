...
public class ShowAllPCNTest {
	...
	public void setup() throws Exception {
		...
		try {
			...
			showallpcn = new ShowAllPCN(WebDriver_Instance.driver);
	...
	@DataProvider(name = "Show All PCN")
	...
	public void ApproverLogin(String username, String password) throws InterruptedException {
		...
		Thread.sleep(2000);	
		Action.click(ApproverHomePage.apprMenuShowAllPCN);
		
		Thread.sleep(2000);
		Action.click(ShowAllPCN.showAllSearch);
