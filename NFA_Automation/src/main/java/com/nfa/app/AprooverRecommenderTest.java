...
import com.nfa.pom.ApproverPage;
...
public class AprooverRecommenderTest {
	...
	public void setup() throws Exception {
		...
		try {
			...
			htmlReporter.config().setDocumentTitle("NFA Approover and Recommender test");
	...
	public void pcnReport(String username, String password) throws InterruptedException {
		...
		test = extent.createTest("eNFA Portal Approver / Recommender Wise");
		...
		// Click PCN report
		Action.click(HomePage.mrapproverWise);
		...
		Action.click(ApproverPage.apprSubmit);
		
		
		// Logout
		@SuppressWarnings("deprecation")
		WebDriverWait wait = new WebDriverWait(WebDriver_Instance.driver, 10);
		wait.until(ExpectedConditions.elementToBeClickable(ApproverPage.pcnrapprovlogout)).click();
