...
public class RejectPCN {
	...
	public void RejectPCNRequest(String username, String password) throws InterruptedException {
		...
		if(ApproverHomePage.noRecordFound != null || ApproverHomePage.noRecordFound == null) {		
			...
			Thread.sleep(2000);
			((JavascriptExecutor)WebDriver_Instance.driver).executeScript("arguments[0].scrollIntoView();", ApproverHomePage.reviewPCNReject);
			
			Thread.sleep(3000);
			Action.click(ApproverHomePage.reviewPCNReject);
